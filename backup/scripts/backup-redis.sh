...
#
# Schedule: Every day at 03:00 UTC (see backup/cron/backup-crontab)
#
# Usage:
#   bash /opt/infisical/backup/scripts/backup-redis.sh
set -euo pipefail

# Load backup env vars if present (R2 credentials, local backup dir)
BACKUP_ENV_FILE="/opt/infisical/backup/.env.backup"
